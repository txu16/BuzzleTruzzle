...
PROGNAME = BuzzleTruzzle

# Here you must put a list of all of the object files
# that will be compiled into your program. For example
# if you have main.c and myLib.c then in the following
# line you would put main.o and myLib.o
OFILES = main.o screenSetUp.o actions.o font.o Images/brick.o Images/startScreen.o Images/gameBackground.o Images/actorDude.o Images/loseScreen.o Images/youWin.o
